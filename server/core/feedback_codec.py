...
_SIGNAL_TO_INDICATOR = {
    ...
    "eyes_closed": INDICATOR_BLINK_ELEVATED,
    ...
    "head_away": INDICATOR_GAZE_DISTRACTED,
    "head_down": INDICATOR_POSTURE_LEANING,
    "yawning": INDICATOR_YAWNING,
